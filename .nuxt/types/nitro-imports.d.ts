declare global {
  ...
  const defineCrudHandlers: typeof import('../../server/utils/supabase').defineCrudHandlers
  ...
  const getClient: typeof import('../../server/utils/supabase').getClient
  ...
  const getUser: typeof import('../../server/utils/supabase').getUser
  ...
  const requireAuth: typeof import('../../server/utils/supabase').requireAuth
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/Users/difusal/Documents/GitHub/turbo/testing/ongandessur-platform/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from '/Users/difusal/Documents/GitHub/turbo/testing/ongandessur-platform/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { getClient, getUser, requireAuth, defineCrudHandlers } from '/Users/difusal/Documents/GitHub/turbo/testing/ongandessur-platform/server/utils/supabase';