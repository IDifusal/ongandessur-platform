  ...
  const pages = [
    {
      slug: 'home',
      title: 'Inicio',
      description: 'ONG Andes Sur — biodiversidad, ayuda solidaria a niños y jóvenes, desarrollo sostenible en el sur del Perú.',
    ...
    },
    {
      slug: 'nosotros',
      title: 'Nosotros',
      description: 'Conoce nuestra misión, visión y el equipo profesional de ONG Andes Sur en Arequipa, Perú.',
      published_at: new Date().toISOString(),
      content: {
        sections: [
          {
    ...
    },
    {
      slug: 'proyectos',
      title: 'Proyectos',
      description: 'Proyectos de desarrollo sostenible, educación y medio ambiente que impulsa ONG Andes Sur.',
      published_at: new Date().toISOString(),
      content: {
        sections: [
          {
    ...
    },
    {
      slug: 'servicios',
      title: 'Servicios',
      description: 'Asesoría de tesis, gestión empresarial y consultoría pública ofrecidos por ONG Andes Sur.',
      published_at: new Date().toISOString(),
      content: {
        sections: [
          {
    ...
    },
    {
      slug: 'contacto',
      title: 'Contacto',
      description: 'Contáctate con ONG Andes Sur en Arequipa, Perú. Escríbenos a ongandessur@gmail.com.',
      published_at: new Date().toISOString(),
      content: {
        sections: [
          {
